describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    let sh = await prodItem.getProperty('shadowRoot');
    const button = await sh.$('button');
  ...
  it('Checking number of items in cart on screen', async () => {
   ...
   let cartText = await cartCount.getProperty('innerText');
    let value = await cartText.jsonValue();
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    let sh, button, buttonText, buttonValue; 

    for(let i=1; i< prodItems.length; i++){
      sh = await prodItems[i].getProperty('shadowRoot');
      button = await sh.$('button');
      buttonText = await button.getProperty('innerText');
      buttonValue = await buttonText.jsonValue();
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    let shadow, button, buttonText, buttonValue; 
